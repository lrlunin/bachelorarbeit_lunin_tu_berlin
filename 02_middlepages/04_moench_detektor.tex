...
\end{figure}
\noindent
Dadurch können die Spannungen mit mehreren \gls{adc}s parallel in allen Spalten digitalisiert und Auslesezeiten somit wesentlich verkürzt werden. Die typische Auslesezeit einer Zeile liegt im \si{\micro\second}-Bereich, was im Falle eines \qtyproduct{2048 x 2048}{\px} Bildes einige \si{\milli\second} für den ganzen Sensor ergibt.
