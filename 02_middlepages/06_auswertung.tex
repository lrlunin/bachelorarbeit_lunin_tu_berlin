...
\end{equation}
\noindent
Somit kann die Standardabweichung der Summe über \SI{3}{\px}$\times$\SI{3}{\px}-Umgebung
\begin{equation}
...
\begin{equation}
    \sigma_{1\times 1}^2 = \sum_{i=1}^1\sigma_R^2 \Rightarrow \sigma_{1\times 1} = \sigma_R
\end{equation}
\noindent
Man kann vergleichen, welchen Anteil des Rauschens je nach $\sigma$ höher als der Schwellenwert $s_V = \SI{100}{\adu}$ bzw. Schwellenwert $s_Q = \SI{180}{\adu}$ wird und wird also als ein Photon gekennzeichnet. Dafür werden die Rausch-Verteilungen, die der Gauß-Verteilung $G(W, \mu, \sigma, A)$ (s. Gl. (\ref{eq:gauss_funktion}) unterliegen, genommen und folgende Integrale ausgerechnet:
...
\end{equation}
\noindent
Somit ist das Verhältnis von Anzahl von Rauschclustern, die den Schwellenwert $s_Q = \SI{180}{\adu}$ unterschreiten, und von Pixeln die den Schwellenwert $s_V = \SI{100}{\adu}$
\begin{equation}
    \frac{3{,}19A\cdot 10^{-6}}{2{,}65A\cdot 10^{-7}} \approx \num{12}
\end{equation}
