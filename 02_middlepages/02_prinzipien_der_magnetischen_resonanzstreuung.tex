...
\noindent
Die starke perpendikulare magnetische Anisotropie, wodurch der höhere Wert von $S_m(\mathbf{q})$ erreicht wird, kann bei mehrschichtigen Systemen getroffen werden, die aus abwechselnden ferro- und antiferromagnetischen Beschichtungen bestehen. Typischerweise werden die Elementenpaare von Co/Pt oder Fe/Gd benutzt. 

\noindent
Die Gesamtenergie eines Mehrschichtsystems lässt sich als die Summe der folgenden Energien betrachten: Energie der Austauschwechselwirkung, Domänenwand-Energie und Energie der Anisotropie \cite[Kap. 3.2]{hubert_magnetic_1998}, \cite{hellwig_domain_2007}. Die werden weiter genauer betrachtet.

\newacronym{fm}{FM}{ferromagnetisch}
\newacronym{am}{AM}{antiferromagnetisch}
\noindent
Die Austauschwechselwirkung nimmt sehr stark mit dem Abstand ab und deren Einfluss ist deswegen nur auf sehr kurzen Abständen zu betrachten. Die entsteht beispielsweise zwischen den benachbarten Schichten und kann verschieden sein. Sind die Domänenmagnetisierungen der benachbarten Schichten entgegensetzt ausgerichtet - nennt man diese Art der Kopllung \gls{am}. Sind sie in dieselbe Richtung orientiert - heißt diese Kopplung \gls{fm}. Die Art der Kopplung wirkt sich unmittelbar auf die Domänengröße und die Gesamtmagnetisierung der Probe aus. Dies ist schematisch in der Abb. \ref{fig:am_fm_kopplung} dargestellt.

\noindent
Die Domänenwand-Energie ...

\noindent
Die Energie der Anisotropie ist innnerhalb einer Schicht zu betrachten.


\noindent
Solche Systeme haben typischerweise mehrere metastabile Zustände. Die Bildung eines bestimmten Systemzustandes hängt von mehreren inneren und äußeren Faktoren ab. Zu denen gehören die Schichtenzahl, die Temperatur, die Stärke und zeitliche Dynamik externes Magnetfeldes, das angelegt wird oder bereits angelegt wurde.  
...
\noindent
Im Falle der \gls{fm}-Kopplung summieren sich die Magnetisierungstärken der einzelnen Schichten auf. Dadurch wird die resultierende Gesammagnetisierung entlang der $z$-Achse verstärkt. Der Spin-Bahn-Kopplung wirkt die Formanistropie innerhalb einer Schicht entgegen. Die Austauschwechselwirkung tritt lediglich an den Grenzschichten auf. D.h., dass die Zahl von Grenzschichten, also die Wiederholungszahl, gegen der Schichtendicke maximiert werden soll, um die möglichst starke \gls{fm}-Kopplung zu erzeugen. 

\noindent


\noindent
So ist die gewünschte hohe perpendikulare magnetische Anisotropie ist bei der \gls{fm}-Kopplung zu erreichen.
...
\begin{figure}[H]
    \centering
    \subfloat[]{\includegraphics[width=0.27\textwidth]{images/ds211221_R1_membrane_amplitude_crop.png} \label{fig:mfm_ds211221}}
    \hspace{1cm}
    \subfloat[]{\includegraphics[width=0.27\textwidth]{images/ds211221_R1_membrane_amplitude_crop_2um .png} \label{fig:mfm_ds211221_2um}}
    \hspace{1cm}
    \subfloat[]{\includegraphics[width=0.27\textwidth]{images/ds220126_R1_membrane_amplitude_cropped.png} \label{fig:mfm_ds220126}}
