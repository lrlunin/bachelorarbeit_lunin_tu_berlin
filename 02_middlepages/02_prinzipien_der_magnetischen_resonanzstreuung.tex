...
\noindent
Die Gesamtenergie eines mehrschichtigen Systems ist als die Summe von der Energie der magnetischen Austauschwechselwirkung, Domänenwand-Energie und Energie der magnetischen Anisotropie \cite{hellwig_domain_2007}, \cite[Kap. 3.2]{hubert_magnetic_1998} darzustellen. Solche Systeme haben typischerweise mehrere metastabile Zustände. Die Bildung eines bestimmten Systemzustandes hängt von mehreren inneren und äußeren Faktoren ab. Zu denen gehören die Schichtenzahl, die Temperatur, die Stärke und zeitliche Dynamik externes Magnetfeldes, das angelegt wird oder bereits angelegt wurde.  

\newacronym{fm}{FM}{ferromagnetisch}
\newacronym{am}{AM}{antiferromagnetisch}

\noindent
Die Austauschwechselwirkung zwischen den benachbarten Schichten kann \gls{fm} oder \gls{am} stattfinden.
...
\noindent
Die gewünschte hohe perpendikulare magnetische Anisotropie is
